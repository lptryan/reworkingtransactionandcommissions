...
const conditions: Condition[] = [
  {
    ...
    submittedDate: "03/12/26 10:41", submittedBy: "Rachel Simmons",
    clearedDate: "03/12/26 10:41", clearedBy: "Rachel Simmons",
    createdBy: "Rachel Simmons", createdAt: "03/06/26 12:39",
  ...
  },
  {
    ...
    submittedDate: "03/09/26 10:00", submittedBy: "Rachel Simmons",
    clearedDate: "03/09/26 10:00", clearedBy: "Rachel Simmons",
    createdBy: "Rachel Simmons", createdAt: "03/06/26 12:41",
    tags: [{ label: "Pre-Compliance", color: "gold" }, { label: "If Applicable", color: "green" }],
  },
  {
    description: "Information About Brokerage Services",
    submittedDate: "03/09/26 10:05", submittedBy: "Rachel Simmons",
    clearedDate: "03/09/26 10:05", clearedBy: "Rachel Simmons",
  ...
  },
  {
    ...
    submittedDate: "03/09/26 09:59", submittedBy: "Rachel Simmons",
    clearedDate: "03/09/26 09:59", clearedBy: "Rachel Simmons",
    createdBy: "System Auto", createdAt: "03/06/26 12:41",
    tags: [{ label: "Pre-Compliance", color: "gold" }, { label: "Required", color: "red" }],
  },
  {
